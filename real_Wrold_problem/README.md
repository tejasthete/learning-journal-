...
├── solutions.py                    # My answers, question by question
└── README.md
```
...
**Data Transformation**
- Creating new columns like total nights and total guests
...
Python, pandas, numpy — keeping it simple for now, might add matplotlib/seaborn later for visuals.
