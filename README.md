...
|2026-09-04	|Matplotlib	plt.subplots(2,3) |— combined 6 individual charts into one Hotel Booking Dashboard (hotel bookings, cancellation ratio, monthly trend, market segment, waiting list, reservation status) using fig.suptitle(), per-axis ax[row,col].set_title(), and plt.tight_layout()
